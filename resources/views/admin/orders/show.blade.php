  ...
  <x-slot name="header">
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">
          ...
          <span class="dropdown float-right">
              <button href="#" class="btn btn-info dropdown-toggle" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
              {{ $order->getStatus() }}
              </button>
                ...
                <tbody >
                  ...
                  <tr>
                    <td colspan="2 px-0">
                      ...
                      <a href="{{ url('admin/orders') }}" class="btn  btn-warning btn-block"> Go to Orders</a>
