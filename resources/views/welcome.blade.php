        ...
        <div id="carouselExampleCaptions" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active" data-interval='3000'>
                <img src="{{ asset('images/chinese/1.jpg') }}" class="d-block w-100" style="max-height: 500px;" alt="...">
              ...
              <div class="carousel-item" data-interval='3000'>
                <img  src="{{ asset("images/fastfood/1.jpg") }}" class="d-block w-100" style="max-height: 500px;" alt="...">
                <div class="carousel-caption d-none d-md-block">
                  <h3 class="fs-1 fw-bold">Fast Food</h3>
                  <p>Fast food refers to food that can be prepared and served quickly..</p>
                </div>
              </div>
              <div class="carousel-item" data-interval='3000'>
                <img  src="{{ asset("images/homemade/1.jpg") }}" class="d-block w-100" style="max-height: 500px;" alt="...">
                <div class="carousel-caption d-none d-md-block">
